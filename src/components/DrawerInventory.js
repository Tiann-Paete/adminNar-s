            ...
            <table className="w-full text-xs sm:text-sm text-left text-gray-500">
              <thead className="text-xs text-gray-700 uppercase bg-gray-50">
                <tr>
                  ...
                  <th scope="col" className="px-2 py-2 sm:px-3 sm:py-3">Order</th>
                  <th scope="col" className="px-2 py-2 sm:px-3 sm:py-3">Rate</th>
              ...
              <tbody>
                <AnimatePresence>
                  ...
                  <td className="px-2 py-2 sm:px-3 sm:py-3">{product.rating}</td>
                  <td className="px-2 py-2 sm:px-3 sm:py-3">
